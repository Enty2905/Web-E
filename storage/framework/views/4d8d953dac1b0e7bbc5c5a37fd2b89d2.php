            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="<?php echo e(URL::to('/found-order-day')); ?>">Thống kê theo ngày</a></li>
                        <li><a href="<?php echo e(URL::to('/found-order-year')); ?>">Thống kê theo tuần </a></li>
                        <li><a href="<?php echo e(URL::to('/found-order-mounth')); ?>">Thống kê theo tháng</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="<?php echo e(URL::to('/add-brand-product')); ?>">Thêm hiệu sản phẩm</a></li>
						<li><a href="<?php echo e(URL::to('/all-brand-product')); ?>">Liệt kê thương hiệu sản phẩm</a></li>
                ...
                <li>
                    <a href="<?php echo e(URL::to('/multi-email')); ?>">
...
<?php /**PATH C:\2-HK1\CN&LTW\test-web-laravel\resources\views/admin_layout.blade.php ENDPATH**/ ?>