            ...
            <td><span class="text-ellipsis">
              <?php
               if($cate_pro->category_status==1){
                ?>
                <a href="<?php echo e(URL::to('/unactive-category-product/'.$cate_pro->category_id)); ?>"><span class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                <?php
                 }else{
                ?>  
                 <a href="<?php echo e(URL::to('/active-category-product/'.$cate_pro->category_id)); ?>"><span class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                <?php
               }
              ?>
            </span></td>
      ...
      <div class="row">
        ...
        <div class="col-sm-7 text-right text-center-xs">                
          <ul class="pagination pagination-sm m-t-none m-b-none">
            ...
            <li><?php echo e($all_category_product->appends(['sort' => 'category_id'])->links()); ?></li>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\2-HK1\CN&LTW\test-web-laravel\resources\views/admin/all_category_product.blade.php ENDPATH**/ ?>